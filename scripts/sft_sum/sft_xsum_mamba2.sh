...
torchrun --standalone --nnodes=1 --nproc_per_node=16 sft/sft_summarization.py \
    ...
    --config_path /ossfs/workspace/antnlp/lengjiaqi.ljq/mb2-370M-wo-pass/checkpoint-61440/config.json \
    --min_lr_rate 0.2 \
    --warmup_ratio 0.02 \
    --epochs 5 \
    ...
    --output_dir /ossfs/workspace/antnlp/aaron.hx/mamba_370M_xsum \
...
torchrun --standalone --nnodes=1 --nproc_per_node=16 sft/sft_summarization.py \
    ...
    --gradient_accumulation_steps 1 \
    --checkpoint_path /ossfs/workspace/antnlp/lengjiaqi.ljq/mb2-370M-wo-pass/checkpoint-61440 \
    --output_dir /ossfs/workspace/antnlp/aaron.hx/mamba_370M_cnn \
    --model_type mamba_nsa